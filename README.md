...
> **MetaFed: Carbon-Aware Client Selection and Auditable Orchestration for Federated Learning**
> Paul Kofi Agbadi, Fagen Li, Jianbin Gao, Qi Xia\*, Hu Xia, Victor Kombou
> School of Computer Science and Engineering (School of Cyber Security), UESTC
> \*Corresponding author: xiaqi@uestc.edu.cn
...
[Yagiz et al. (2025)](https://github.com/afrilab/MetaFed-FL/tree/37bdec2)
...
```bash
git clone https://github.com/sparrowpaul/metafed-green-fl.git
cd metafed-green-fl
pip install -e .
```
...
```bibtex
@article{agbadi2026metafed,
  title   = {MetaFed: Carbon-Aware Client Selection and Auditable
             Orchestration for Federated Learning},
  author  = {Agbadi, Paul Kofi and Li, Fagen and Gao, Jianbin and
             Xia, Qi and Xia, Hu and Kombou, Victor},
...
If you use the base framework, please also cite:

```bibtex
@misc{yagiz2025metafed,
  title         = {MetaFed: Advancing Privacy, Performance, and Sustainability
                   in Federated Metaverse Systems},
...
Base framework by Yagiz, Cengiz, and Goktas (2025) —
[afrilab/MetaFed-FL](https://github.com/afrilab/MetaFed-FL), MIT licence.
